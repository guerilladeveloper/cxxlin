...
template <uint32 D>
vec<D,real32&>::vec(const real32& val)
{
	for (uint32 i=0;i<D;++i)
	{
		*e[i]=val;
...
template <uint32 D>
vec<D,real32> vec<D,real32&>::operator+(const vec<D,real32&>& rhs) const
{
	vec<D,real32> result={};
...
template <uint32 D>
vec<D,real32> vec<D,real32&>::operator-() const
{
	vec<D,real32> result={};
	for (uint32 i=0;i<D;++i)
	{
...
template <uint32 D>
vec<D,real32> vec<D,real32&>::operator*(real32 scalar) const
{
	vec<D,real32> result={};
	for (uint32 i=0;i<D;++i)
	{
...
template <uint32 D>
bool32 vec<D,real32&>::operator==(const vec<D,real32&>& rhs) const
{
	bool32 result=1;
